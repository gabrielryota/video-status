  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(4,4,12,.95)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 3000, backdropFilter: "blur(8px)" }}>
      <div style={{ textAlign: "center", animation: "fadeUp .3s ease both" }}>
        ...
        <h2 style={{ fontFamily: "'Syne',sans-serif", fontWeight: 800, fontSize: 22, color: "#fff", letterSpacing: "-.02em", marginBottom: 8 }}>Acesso restrito</h2>
        <p style={{ color: "#555", fontSize: 13, marginBottom: 28, fontFamily: "'DM Sans',sans-serif" }}>Digite a senha para editar o painel.</p>
        <div style={{ display: "flex", flexDirection: "column", gap: 10, alignItems: "center" }}>
          <input
            ...
            placeholder="Senha"
            style={{ padding: "12px 18px", borderRadius: 10, background: "#0d0d1a", border: `1px solid ${error ? "#FF4757" : "#1e1e38"}`, color: "#fff", fontSize: 14, outline: "none", width: 240, fontFamily: "'DM Sans',sans-serif", textAlign: "center", letterSpacing: ".1em" }}
          />
          {error && <span style={{ fontSize: 12, color: "#FF4757", fontFamily: "'DM Sans',sans-serif" }}>Senha incorreta. Tente novamente.</span>}
          <div style={{ display: "flex", gap: 10, marginTop: 4 }}>
            <button onClick={onCancel}
              style={{ padding: "10px 20px", borderRadius: 10, border: "1px solid #1e1e38", background: "transparent", color: "#555", fontSize: 12, cursor: "pointer", fontFamily: "'Syne',sans-serif", fontWeight: 700 }}>
              ← Voltar
            </button>
            <button onClick={tryPassword}
              style={{ padding: "10px 24px", borderRadius: 10, border: "none", background: "linear-gradient(135deg,#7B8CFF,#A29BFE)", color: "#fff", fontWeight: 800, fontSize: 13, cursor: "pointer", fontFamily: "'Syne',sans-serif" }}>
              Entrar
            </button>
          </div>
        </div>
